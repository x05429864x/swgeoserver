...
public class CompressFileUtils {
	...
	public static void unZipFiles(File zipFile, String descDir) throws IOException {
		...
		zip.close();
		// zipFile.delete();
		FileUtils.deleteQuietly(zipFile); // 删除文件
		// FilesTools.deleteAllFiles(zipFile);
...
//				System.out.println(a.getMainHeader().getEncryptVersion());
			...
			FileUtils.deleteQuietly((new File(srcRarPath))); // 删除文件
			// FilesTools.deleteAllFiles(new File(srcRarPath));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
