package com.siweidg.swgeoserver.comm.base;

import com.siweidg.swgeoserver.rest.GeoServerRESTManager;
import com.siweidg.swgeoserver.rest.GeoServerRESTPublisher;
import com.siweidg.swgeoserver.rest.GeoServerRESTReader;
...
public class BaseGeoserverREST  {
    ...
    public static final String PASSWORLD = "geoserver";
    ...
    static {
        /*RESTURL = getenv("gsmgr_resturl", "http://zz:8080/geoserver");
        ...
        enabled = getenv("gsmgr_resttest", "true").equalsIgnoreCase("true");
        if (!enabled)
    ...
    public static void setUp() throws Exception {
        ...
        if (enabled) {
            ...
            if (v.compareTo(GSVersionDecoder.VERSION.getVersion(GS_VERSION))!=0){
