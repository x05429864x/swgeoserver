...
import com.siweidg.swgeoserver.comm.utils.FileUtils;
...
import com.siweidg.swgeoserver.rest.decoder.*;
    ...
    public Object publishGis(@ApiParam(name = "param",value = "{\n" +
        ...
        try{
            ...
            if(layer == null){
                ...
                if(restStore==null){
                    com.siweidg.swgeoserver.rest.encoder.datastore.GSPostGISDatastoreEncoder store = new com.siweidg.swgeoserver.rest.encoder.datastore.GSPostGISDatastoreEncoder(dataStore);
